    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="ghost" className="relative p-0 w-10 h-10 rounded-full hover:scale-110 transition-transform duration-300">
          <Avatar className="w-10 h-10 border-2 border-teal/40 hover:border-teal transition-colors">
            <AvatarFallback className="bg-gradient-to-br from-teal-dark to-coral text-white font-bold">
              AA
            </AvatarFallback>
          </Avatar>
          <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-teal border-2 border-white rounded-full animate-pulse"></div>
        </Button>
      </PopoverTrigger>
      
      <PopoverContent className="w-80 p-0 glass-strong border-teal/20 shadow-xl" align="end" sideOffset={10}>
        <div className="p-6 space-y-4">
          {/* Header */}
          <div className="flex items-center space-x-3">
            <Avatar className="w-12 h-12">
              <AvatarFallback className="bg-gradient-to-br from-teal-dark to-coral text-white font-bold text-lg">
                AA
              </AvatarFallback>
            </Avatar>
            <div>
          ...
          <div className="space-y-2">
            <Badge className="bg-teal-light text-teal-dark border-teal/30 hover:bg-teal-light">
              🟢 Open to work
            </Badge>
          ...
          <div className="space-y-2">
            ...
            <Button className="w-full justify-start bg-background hover:bg-accent text-foreground border border-border" variant="ghost" asChild>
              <a href="https://drive.google.com/file/d/1K8cK897qgGwDqbKxofTqqlURNZgCeWmt/view?usp=drivesdk" target="_blank" rel="noopener noreferrer">
                <Download className="w-4 h-4 mr-2 text-teal-dark" />
                Download Resume
              </a>
            </Button>
